...
@section('contenido')
    <div class="bg-white p-6 rounded shadow max-w-xl">
        <form method="POST" action="{{ route('movimientos.entrada.store') }}" class="space-y-4">
            @csrf
            <div>
            ...
            <button class="bg-gray-800 text-white px-4 py-2 rounded-md text-sm">Registrar entrada</button>
        </form>
    </div>
@endsection
